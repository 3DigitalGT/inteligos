...
class AccountPrintJournalReport(models.TransientModel):
    ...
    def _print_report(self, data):
        ...
        if self.excel_file:
            ...
            return {
                ...
                'url': 'web/content/?model=account.print.journal.report&download=true&field'
    ...
    def print_in_pdf(self):
        ...
        datas['form'] = res
        return self.env.ref('accounting_report_journals_audit.action_journal_report_template').report_action([],
                                                                                                             data=datas)
